...
- Burger menu with museum information
- Main block “Художній музей”
- Clear visual hierarchy and typography focus
...
## Gallery
- Image grid layout
- CSS-only slider on mobile devices
- No JavaScript used
...
```bash
git clone https://github.com/Vall-Re/Landing-page_Museum
